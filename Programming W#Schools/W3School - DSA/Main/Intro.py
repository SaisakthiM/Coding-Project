...
My Understanding : Now, let's take a lego building 
I challenge you to build a structure like building in the most stable way,what will you do
"Oh, Simple make the base bigger and top smaller like pyramid"
yes, it is right do you know the reason why making base bigger makes the structure stable
"The base gets more contact with the ground which makes it stable and reduced the top to reduce gravity and other forces"
This is Data Structure. Structuring the data in a way which makes it more efficient to process than its raw form
Here you go
...
My Understating : Let's take a egg. you want the insides of that egg for making cake.
what do generally anyone do, break the egg
do you put in a flour to take the insides, no 
why, because all the data is not same. each data has a different type and 
need different methods to extract it efficiently and usefully
that "different methods" replace it with "set of instructions" and
yourself got the definition of algorithms
